const StepdownForm = () => {
    ...
    return (
        <form id="step-downs-form" method="POST">
            <h2 className="text-base/7 font-semibold text-gray-900">Step-Downs Information</h2>
            <p className="mt-1 text-sm/6 text-gray-600">Please provide details for the step-down.</p>
            <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                ...
                <div className="sm:col-span-3">
                    <label htmlFor="step-down-date" className="block text-sm font-medium text-gray-900">Step-down
                        Date</label>
                    <div className="mt-2">
                        <input type="date" name="step-down-date" id="step-down-date"
                               className="block w-full rounded-md border border-gray-300 bg-white px-3 py-1.5 text-base text-gray-900 placeholder:text-gray-400 focus:border-indigo-600 focus:outline-none sm:text-sm"/>
                    </div>
                </div>
                <div className="sm:col-span-4">
                    <label htmlFor="loc-stepping-down-to" className="block text-sm font-medium text-gray-900">Which LOC
                        are they Stepping down to?</label>
                    <div className="mt-2 relative">
                        <select id="loc-stepping-down-to" name="loc-stepping-down-to"
